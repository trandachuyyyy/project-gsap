    ...
    return (
        <header className="header max-w-7xl fixed w-full left-1/2 top-0 -translate-x-1/2 z-50  px-8 py-4 flex justify-between items-center">
            ...
            <div
                ...
                className="cursor-pointer text-xl font-bold dark:text-white text-black hover:text-teal-400 duration-300"
            >
                Huy Tran
            </div>
                ...
                {["Home", "About", "Skills", "Projects"].map((name, index) => {
                    ...
                    return (
                        <button
                            ...
                            className="relative text-sm uppercase dark:text-gray-300 text-black hover:text-teal-400 duration-300 group"
                        >
                            {name}
            ...
            <button onClick={() => setOpenMenu(!openMenu)} className="md:hidden dark:text-white text-black">
                <IoMenu size={28} />
            </button>
        </header>
    );

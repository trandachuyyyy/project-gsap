        ...
        <div>
            ...
            >
                <div
                    ...
                    className="lg:text-base text-sm font-semibold uppercase"
                >
                    Huy Tran
                </div>
                <div className="flex justify-between gap-4">
                    {nav.map((e: any) => {
                        return (
                            <div
                                onClick={() => handleScrollSession(e.href)}
            ...
            <div className="logo-container">
                <div className="logo uppercase text-center font-bold fixed top-0 translate-y-1/2 w-full ">
                    <div className="flex flex-col lg:text-2xl text-sm">
                        <span> Hello</span>
                        <span>you have come to my page</span>
                    </div>
                </div>
                <p
                    onClick={() => handleScrollSession("ss-home")}
            ...
            <div className="container w-full h-screen bg-gray-100 max-w-full"></div>
        </div>
    );
};
